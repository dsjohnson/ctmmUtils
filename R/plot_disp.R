...
#' See \code{\link[ctmmlUtils]{migration_det}}
#' @param data Original data used by \code{migration_det} call.
#' @param migr_tbl Results table produced by \code{migration_det}.
#' @export
#' @author Devin S. Johnson
#' @import sf fuzzyjoin dplyr ggplot2
plot_disp <- function(data, migr_tbl){
